...
class Player:
    def __init__(self, x_size, y_size, team, parts):
    ...
    def draw_snake(self, body_sprite, head_sprites):
        if self.__alive:
            for block in self.__body:
                block_pic = Sprite(body_sprite,
            ...
            if self.__direction == Side.west:
                head_sprite = head_sprites.w
            elif self.__direction == Side.north:
                head_sprite = head_sprites.n
            elif self.__direction == Side.south:
                head_sprite = head_sprites.s
            else:
                head_sprite = head_sprites.e
